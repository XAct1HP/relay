                ...
                {unreadConversationRows.length === 0 ? (
                  ...
                  unreadConversationRows.map((conversation) => (
                    <div
                      ...
                      className="rounded-[1.75rem] border border-blue-400/20 bg-blue-500/10 p-5 text-white shadow-[0_10px_40px_rgba(0,0,0,0.18)] backdrop-blur-xl"
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          ...
                          <p className="mt-2 text-white/75">{conversation.latestMessage}</p>
              ...
              <div className="mt-4 space-y-4">
                {notifications?.length === 0 ? (
                  ...
                  notifications?.map((notification) => (
                    <div
                      key={notification.id}
                      className="rounded-[1.75rem] border border-white/10 bg-white/[0.04] p-5 text-white shadow-[0_10px_40px_rgba(0,0,0,0.18)] backdrop-blur-xl"
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <h3 className="text-lg font-semibold text-white">
