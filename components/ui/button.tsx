...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-white text-black hover:bg-white/90 shadow-[0_6px_24px_rgba(255,255,255,0.08)]",
        outline:
          "border-white/10 bg-white/5 text-white hover:bg-white/10 aria-expanded:bg-white/10 aria-expanded:text-white",
        secondary:
          "bg-white/5 text-white border border-white/10 hover:bg-white/10 aria-expanded:bg-white/10 aria-expanded:text-white",
        ghost:
          "text-white/80 hover:bg-white/5 hover:text-white aria-expanded:bg-white/10 aria-expanded:text-white",
        destructive:
          "bg-red-500/12 text-red-200 border border-red-400/20 hover:bg-red-500/20 focus-visible:border-red-400/40 focus-visible:ring-red-400/20",
